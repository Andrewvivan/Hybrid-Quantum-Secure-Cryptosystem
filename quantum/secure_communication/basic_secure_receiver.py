...
class QuantumSecureReceiver:
    ...
    def start_server(self):
        ...
        try:
            ...
            self.insert_message(f"Waiting for sender connection on port {port}...\n")
            ...
            self.insert_message(f"Connected to sender from {client_address} in {connection_duration:.2f}ms. Ready to chat.\n")
